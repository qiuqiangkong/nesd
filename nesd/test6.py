import os
import nesd.d19t3_evaluation_metrics as evaluation_metrics
import nesd.d19t3_cls_feature_class as cls_feature_class
import numpy as np
...
# INPUT DIRECTORY
# ref_desc_files = '/home/tiger/datasets/dcase2019/task3/metadata_eval' # reference description 
ref_desc_files = './d19t3_gt'
...
pred_output_format_files = './d19t3_pred'
