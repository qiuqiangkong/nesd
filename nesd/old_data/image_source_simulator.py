...
from nesd.old_data.utils import norm, fractional_delay_filter, FractionalDelay, DirectionSampler, sph2cart, get_cos, Agent, repeat_to_length, cart2sph, Rotator3D, sample_agent_look_direction, sample_positive_depth, sample_negative_depth, int16_to_float32, PAD
import time
import h5py
import random
...
class ImageSourceSimulator:
    ...
    def __init__(self, audios_dir, expand_frames=None, simulator_configs=None): 
        ...
        if add_noise == "tau-noise":
            ...
            noise_hdf5s_dir = "/home/qiuqiangkong/workspaces/nesd/hdf5s/tau-noise"
    ...
    def sample_mic_positions(self, exclude_positions, exclude_raidus):
        ...
        if mic_array_type == "single":
            ...
            mics_yaml = "./old_microphones/eigenmike.yaml"
...
class ImageSourceSimulator:
    ...
    def __init__(self, audios_dir, expand_frames=None, simulator_configs=None): 
        ...
        if debug:
            ...
            self.source_positions = np.array([[1.1, 1.2, 1.3], [-1.1, -1.2, 1.3]])
    ...
    def sample_sources(self):
        ...
        # audio_paths = np.random.choice(self.audio_paths, size=self.sources_num, replace=False)
        audio_paths = [
            '/home/qiuqiangkong/workspaces/nesd/audios/vctk_2s_segments/train/p227_388_0000.wav',
            '/home/qiuqiangkong/workspaces/nesd/audios/vctk_2s_segments/train/p226_011_0001.wav'
        ]
