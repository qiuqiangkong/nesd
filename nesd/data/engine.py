...
'''
import h5py
from nesd.utils import fractional_delay_filter_old
class ImageSourceEngine:
    def __init__(self, 
        environment, 
        source_positions,
        ...
        self.sample_rate = sample_rate
        self.compute_direct_ir_only = compute_direct_ir_only
        self.center_mic_pos = center_mic_pos
        ...
        for src_images in srcs_images:
            ...
            for img in src_images:
                ...
                if False:
                    ...
                    mic_to_img = img - self.center_mic_pos
                ...
                # old
                # h_delay = distance_gain * fractional_delay_filter_old(delayed_samples)
                ...
                if self.mic_spatial_irs:
                    ...
                    #     h_mic = hf["h"][int(incident_angle_deg)] 
            ...
            # old
            # max_filter_len = max([len(h) for h in h_list])
            # h_reverb = np.zeros(max_filter_len)
            # for h in h_list:
            #     h_reverb[0 : len(h)] += h
            # h_direct = None
    ...
    def compute_spatial_ir(self):
        ...
        for src_images in srcs_images:
            ...
            for img in src_images:
                ...
                if self.center_mic_pos is not None:
                    mic_to_img = img - self.center_mic_pos
                else:
                    mic_to_img = img - self.mic_position
