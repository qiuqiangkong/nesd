...
from evaluate.dcase2020_task3 import read_dcase2020_task3_csv as read_dcase2021_task3_csv
...
if select == "1":
    ...
    panaroma_paths = [Path(panaromas_dir, "fold6_room1_mix001.pkl")]
...
def plot_panaroma(args):
    ...
    for panaroma_path in panaroma_paths:
        ...
        frame_indexes, class_indexes, azimuths, elevations, distances = read_dcase2021_task3_csv(csv_path=gt_csv_path)
