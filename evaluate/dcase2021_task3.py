...
if select == "1":
    ...
    panaromas_dir = Path(workspace, "results/dcase2021_task3/panaroma")
    panaroma_paths = [Path(workspace, "results/dcase2021_task3/panaroma/fold6_room1_mix001.pkl")]

    pred_csvs_dir = Path(workspace, "results/dcase2021_task3/pred_csvs")
