import os
from evaluate import d24t3_SELD_evaluation_metrics as SELD_evaluation_metrics
from evaluate import d24t3_cls_feature_class as cls_feature_class
from evaluate import d24t3_parameters as parameters
import numpy as np
...
class ComputeSELDResults(object):
    def __init__(self, params, ref_files_folder=None, evaluate_distance=None):
        ...
        self.evaluate_distance = evaluate_distance
