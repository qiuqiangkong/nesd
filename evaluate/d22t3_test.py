import os
from evaluate import d22t3_SELD_evaluation_metrics as SELD_evaluation_metrics
from evaluate import d22t3_cls_feature_class as cls_feature_class
from evaluate import d22t3_parameters as parameters
import numpy as np
...
if __name__ == "__main__":
    ...
    pred_output_format_files = "/home/qiuqiangkong/workspaces/nesd/results/dcase2022_task3/pred_csvs"
    ref_files_folder = "/datasets/dcase2022/task3/metadata_dev"

    params = parameters.get_params()
    # Compute just the DCASE final results 
    score_obj = ComputeSELDResults(params, ref_files_folder)
    use_jackknife=False
