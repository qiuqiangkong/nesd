...
from evaluate.dcase2020_task3 import read_dcase2020_task3_csv as read_dcase2024_task3_csv
...
def plot_panaroma(args):
    ...
    for panaroma_path in panaroma_paths:
        ...
        frame_indexes, class_indexes, azimuths, elevations, distances = read_dcase2024_task3_csv(csv_path=gt_csv_path)
