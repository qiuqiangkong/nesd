import os
from evaluate import d21t3_SELD_evaluation_metrics as SELD_evaluation_metrics
from evaluate import d21t3_cls_feature_class as cls_feature_class
from evaluate import d21t3_parameter as parameter
import numpy as np
...
if __name__ == "__main__":
    ...
    # pred_output_format_files = "/home/qiuqiangkong/workspaces/nesd/results/dcase2020_task3/pred_csvs"
    # ref_files_folder = "/datasets/dcase2020/task3/metadata_dev"

    pred_output_format_files = "/home/qiuqiangkong/workspaces/nesd/results/dcase2021_task3/pred_csvs"
    ref_files_folder = "/datasets/dcase2021/task3/metadata_dev"

    # Compute just the DCASE 2021 final results 
    score_obj = ComputeSELDResults(parameter.get_params(), ref_files_folder)
