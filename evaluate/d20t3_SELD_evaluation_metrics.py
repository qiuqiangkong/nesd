                    ...
                    for gt_ind, gt_val in enumerate(gt_ind_list):
                        if gt_val in pred_ind_list:
                            ...
                            if gt_arr.shape[0]==1 and pred_arr.shape[0]==1:
                                ...
                                tmp = distance_between_spherical_coordinates_rad(gt_arr[0][0], gt_arr[0][1], pred_arr[0][0], pred_arr[0][1])
                            else:
                                total_spatial_dist += least_distance_between_gt_pred(gt_arr, pred_arr)
                                tmp = least_distance_between_gt_pred(gt_arr, pred_arr)

                                if False:
                                    a1 = least_distance_between_gt_pred(gt_arr, pred_arr)
                                    print(block_cnt, class_cnt, a1)
