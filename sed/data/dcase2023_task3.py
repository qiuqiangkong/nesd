...
class DCASE2023Task3:
    ...
    def load_targets(self, meta_path, max_frames_num, segment_start_time):
        ...
        targets = read_dcase2023_task3_csv(meta_path, max_frames_num, self.lb_to_id)
...
def read_dcase2023_task3_csv(meta_path, max_frames_num, lb_to_id):
