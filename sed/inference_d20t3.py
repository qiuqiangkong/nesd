...
if select == "1": 
    ...
    gt_csv_path = Path(dataset_dir, "metadata_dev", "fold6_room1_mix100_ov2.csv")

    sed_dir = Path(workspace, "results/dcase2020_task3/sed")
    sed_paths = [Path(sed_dir, "fold6_room1_mix100_ov2.pkl")]
...
def inference(args):
    ...
    checkpoint_path = "checkpoints/train_d20t3/{}/step=3000.pth".format(model_name)
    ...
    for audio_path in audio_paths:
        ...
        targets = read_dcase2020_task3_csv(gt_csv_path, LB_TO_ID)
