...
from sed.data.dcase2023_task3 import read_dcase2023_task3_csv
...
if select == "1": 
    ...
    sed_dir = Path(workspace, "results/dcase2023_task3/sed")
...
def inference(args):
    ...
    # Load checkpoint
    checkpoint_path = "checkpoints/train_d23t3/{}/step=10000.pth".format(model_name)
