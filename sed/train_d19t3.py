...
from data.dcase2019_task3 import DCASE2019Task3
from sed.models.sed import Cnn, CRnn, CRnn1b, CRnn2
...
def get_model(model_name, classes_num):
    ...
    elif model_name == "CRnn1b":
        return CRnn1b(classes_num=classes_num)
    elif model_name == "CRnn2":
        return CRnn2(classes_num=classes_num)
    else:
